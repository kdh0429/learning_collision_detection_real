...
if wandb_use == True:
    wandb.init(project="real_residual", tensorboard=False)
...
f_test = open('../data/Resi/testing_data_.csv', 'r', encoding='utf-8')
...
f_val = open('../data/Resi/validation_data_.csv', 'r', encoding='utf-8')
